	...
	<div class="container">
		<van-tabbar v-model="active" :inactive-color="textCode" :active-color="textCode_select">
			...
			<van-tabbar-item replace to="/dashboard/shoping">
				<span>商城</span>
				<img slot="icon" slot-scope="props" :src="props.active ? shoping_icon.active : shoping_icon.normal">
			</van-tabbar-item>
			

			<van-tabbar-item replace to="/dashboard/recommend">
				<span>推荐</span>
				<img slot="icon" slot-scope="props" :src="props.active ? recommend_icon.active : recommend_icon.normal">
			</van-tabbar-item>
